...
@override
  ...
  Widget build(BuildContext context) {
    return _isloading ? Center(
      ...
      if(_url!=null){
        _mostraimagen(context, 'Quieres enviar esta imagen?', _url);
        setState(() {
          _isloading=false;
        });
      }
...
_mostraimagen(BuildContext context, String mensaje,String url){
      showDialog(
        ...
        builder: (bcontext){
          return AlertDialog(
            title: Text(mensaje),
            content: Image.network(url,loadingBuilder: (BuildContext context, Widget child, ImageChunkEvent loadingProgress) {
    ...
    return  Center(
          ...
          _isloading=true;
               ...
               FlatButton(onPressed: ()=> Navigator.of(bcontext).pop(), child: Text('Cancel'))
            ], 
          );
        }
    );
